    ...
    <button wire:click="storeLikePost" class="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg">
        <div class="  text-gray-900 flex">
            ...
            @endif
            <span class="ml-1 " style="text-decoration: none">{{ $post->count_likes() }}</span>
        </div>
    </button>
