...
<div id="accordion-flush" data-accordion="collapse" aria-label="Accordéon des conforts" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
    @foreach ($conforts as $index => $confort)
        <h2 id="accordion-flush-heading-{{ $index }}">
            <button type="button"
                ...
                <span class="font-bold">{{ ucfirst($confort->title) }}</span>
